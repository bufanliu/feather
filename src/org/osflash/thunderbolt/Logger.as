package org.osflash.thunderbolt
{
	 ...
	 * ************************
	 * <p><pre>
		Logger.info("Flex is calling: A simple string",  myString);<br/>
		Logger.warn ("Flex is calling: Two log objects: A number typed as int and a string",  myNumber,  myString);<br/>
		Logger.error ("Flex is calling: An array with a nested object: ",  myArray);<br/>
		Logger.debug ("Flex is calling: An object with a nested object and nested array", myObject);<br/>
		Logger.info( Logger.memorySnapshot() );
		Logger.error ("Flex is calling: A button with an ID named " + id + " is not found");</pre></p>
	 */	
	public class Logger
	{
		// constants
		 ...
		 * 
		 * @param 	msg				String		log message k
		 * @param 	logObjects		Array		Array of log objects using rest parameter
		 * 
		 */		
